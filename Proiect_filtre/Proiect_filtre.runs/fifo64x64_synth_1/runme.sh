...
HD_PWD='D:/Facultate/AN 3/SSC/PROIECT/Proiect_Final/Proiect_filtre/Proiect_filtre.runs/fifo64x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo64x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo64x64.tcl
