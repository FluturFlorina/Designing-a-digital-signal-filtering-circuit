...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip --snapshot fifo64x64 xil_defaultlib.fifo64x64 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo64x64 -key {Behavioral:sim_1:Functional:fifo64x64} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo64x64.wdb xsim.dir)
