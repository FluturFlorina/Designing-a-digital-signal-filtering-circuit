...
#
# Generated by export_simulation on Mon Jan 08 11:22:33 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './fifo64x64.sh' script.

./fifo64x64.sh -reset_run
...
./fifo64x64.sh -noclean_files

For more information on the script, please type './fifo64x64.sh -help'.
